      ...
      tags: [
        ...
        },
        {
          ...
          children: JSON.stringify({
            ...
            description:
              'Technical paper evaluating urai-ecma: an AST-driven Rust compiler that algorithmically prunes JS/TS syntax and Tailwind bloat, cutting LLM context token consumption by up to 82.7% across real-world repositories.',
          } as const),
        },
