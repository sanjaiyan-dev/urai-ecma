...
head:
  - - link
    - rel: canonical
      href: https://sanjaiyan-dev.github.io/urai-ecma/guide/introduction
---

import { Callout, Badge, Tabs, Tab, Steps, Link } from '@rspress/core/theme';
import { TokenTelemetryHud } from '../../components/TokenTelemetryHud';
import { CompilerPipelineCard } from '../../components/AstPipelineMatrix';
import TokenSavingSimulator from '../../components/TokenSimulator';
import RouteMatrixExplorer from '../../components/RouteMatrixExplorer';
...
<div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: '1rem', margin: '1.5rem 0', }}>
  ...
  <Link href="/architecture/engine-internals" style={{ textDecoration: 'none' }}>
    <div className="metric-card">
  ...
  <Link href="/reference/config" style={{ textDecoration: 'none' }}>
    <div className="metric-card">
